          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="text-sm text-sky-600">Gerenciar lista de pacientes</div>
              </button>
              <button className="w-full text-left p-3 rounded-md bg-green-50 hover:bg-green-100 transition-colors">
                ...
                <div className="text-sm text-green-600">Agendar nova consulta</div>
              </button>
              <button className="w-full text-left p-3 rounded-md bg-purple-50 hover:bg-purple-100 transition-colors">
                ...
                <div className="text-sm text-purple-600">Ver relatórios e estatísticas</div>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 border-l-4 border-sky-500 bg-sky-50">
                <div>
                  <div className="font-medium text-gray-900">Ana Beatriz Costa</div>
                  <div className="text-sm text-gray-600">09:00 - Sessão de Fisioterapia</div>
                </div>
              </div>
              <div className="flex items-center justify-between p-3 border-l-4 border-green-500 bg-green-50">
                <div>
                  ...
                  <div className="text-sm text-gray-600">14:00 - Avaliação Inicial</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs">Redis Off</span>
              </div>
            </div>
          </div>
        </div>
