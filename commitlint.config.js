    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          style: {
            description: 'Mudanças que não afetam o significado do código (espaços em branco, formatação, ponto e vírgula, etc)',
            title: 'Styles',
            emoji: '💎'
          },
          refactor: {
          ...
          build: {
            description: 'Mudanças que afetam o sistema de build ou dependências externas (escopos de exemplo: gulp, broccoli, npm)',
            title: 'Builds',
            emoji: '🛠'
          },
          ci: {
            description: 'Mudanças nos arquivos e scripts de configuração de CI (escopos de exemplo: Travis, Circle, BrowserStack, SauceLabs)',
      ...
      issuesBody: {
        description: 'Se as issues são fechadas, o commit requer um corpo. Por favor, insira uma descrição mais longa do próprio commit'
      },
      issues: {
