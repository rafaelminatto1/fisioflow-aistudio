...
async function performanceTest() {
  ...
  try {
    ...
    console.log(`✅ Health check: ${successCount}/${successCount + errorCount} successful`);
    console.log(`   Average time: ${(healthTime / 10).toFixed(2)}ms per request`);
    ...
    console.log(`   X-Response-Time: ${headers.get('x-response-time') || 'not set'}`);
    ...
    console.log(`✅ Load test: ${loadSuccessCount}/${loadSuccessCount + loadErrorCount} successful`);
    ...
    console.log(`   Requests per second: ${(50 / (loadTime / 1000)).toFixed(2)}`);
    ...
    console.log(`• Concurrent performance: ${(50 / (loadTime / 1000)).toFixed(2)} req/s`);
