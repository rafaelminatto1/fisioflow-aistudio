        ...
        <div className='p-2 border-t border-slate-800 shrink-0'>
          {isCollapsed ? (
            <button
              onClick={() => signOut()}
              title='Sair'
              className='w-full p-2 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-colors duration-200'
            >
              <Image
            ...
            <div className='p-2'>
              <div className='flex items-center'>
                ...
                <button
                  onClick={() => signOut()}
                  title='Sair'
                  className='ml-2 p-2 rounded-md text-slate-400 hover:bg-slate-800 hover:text-white'
                >
