...
const EventCard: React.FC<EventCardProps> = ({ event, onEdit }) => {
  ...
  return (
    <div
      ...
      className='bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col group overflow-hidden cursor-pointer'
    >
      {/* Image and Status */}
        ...
        <div className='mt-4'>
          <div className='flex justify-between items-center text-xs text-slate-500 mb-1'>
            <span className='font-semibold flex items-center'>
              <Users size={14} className='mr-1.5' /> Vagas
            </span>
            <span>
      ...
      <div className='border-t p-2 flex justify-end'>
        <button
          ...
          className='p-2 rounded-full text-slate-400 hover:bg-slate-100 group-hover:opacity-100 opacity-0 transition-opacity'
        >
