    ...
    >
      <div className='relative'>
        ...
        >
          <button
            onClick={onEdit}
            className='bg-white/80 backdrop-blur-sm p-2 rounded-full text-slate-700 hover:bg-white hover:text-teal-600 transition-colors'
          >
            <Edit className='w-4 h-4' />
          </button>
          <button
            onClick={onDelete}
            className='bg-white/80 backdrop-blur-sm p-2 rounded-full text-slate-700 hover:bg-white hover:text-red-600 transition-colors'
          >
      ...
      <div className='p-4 flex-grow flex flex-col'>
        <div className='flex justify-between items-start'>
          ...
          <span
            className={`px-2 py-1 text-xs font-semibold rounded-full ${difficultyColors[exercise.difficulty]}`}
          >
