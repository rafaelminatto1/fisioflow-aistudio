  ...
  return (
    ...
    >
      <div className='py-1' role='menu' aria-orientation='vertical'>
        <button
          onClick={() =>
            handleAction(() => onSetStatus(AppointmentStatus.Completed))
          }
          className='w-full text-left flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900'
          role='menuitem'
        >
          <CheckCircle className='mr-3 h-4 w-4 text-green-500' /> Marcar como
          Realizado
        </button>
        <button
          onClick={() => handleAction(() => onSetPayment('paid'))}
          className='w-full text-left flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900'
          role='menuitem'
        >
