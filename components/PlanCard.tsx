...
const PlanCard: React.FC<PlanCardProps> = ({ plan }) => {
  return (
    <div
      className={`rounded-2xl border-2 p-6 flex flex-col h-full transition-all duration-300 ${plan.popular ? 'border-sky-500 shadow-lg bg-white' : 'border-slate-200 bg-white'}`}
    >
      {plan.popular && (
