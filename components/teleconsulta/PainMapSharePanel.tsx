...
const PainMapSharePanel: React.FC<PainMapSharePanelProps> = ({
  patient,
  onShare,
}) => {
  return (
    <div className='p-4 flex flex-col h-full'>
      ...
      <p className='text-xs text-slate-400 mb-4'>
        Visualize o mapa de dor registrado pelo paciente. Você pode compartilhar
        esta tela para discutir em tempo real.
      </p>
