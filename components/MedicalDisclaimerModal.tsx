      ...
      <div className='bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 text-center'>
        ...
        <div className='mt-4 text-slate-600 space-y-3 text-left'>
          <p>
            ...
            e <strong>não substitui a consulta presencial</strong> com
            profissionais de saúde.
          </p>
          <p>
            Sempre siga as orientações do seu fisioterapeuta e consulte-o em
            caso de dúvidas ou piora dos sintomas.
          </p>
