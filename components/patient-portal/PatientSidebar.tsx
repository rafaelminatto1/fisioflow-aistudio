...
const PatientSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    {
      to: '/portal/partner-services',
      icon: ShoppingCart,
      label: 'Serviços da Parceria',
    },
    ...
    <div className='w-64 bg-white border-r border-slate-200 flex flex-col'>
      <div className='flex items-center justify-center p-4 border-b border-slate-200 h-16'>
        ...
        <span className='text-xl font-bold text-slate-800 ml-2'>
          Fisio<span className='text-teal-500'>Flow</span>
        </span>
      </div>
          ...
          <div className='p-3 rounded-lg bg-slate-100'>
            <div className='flex items-center'>
              ...
              <button
                ...
                title='Sair'
                className='ml-auto p-2 rounded-full text-slate-500 hover:bg-slate-200 hover:text-slate-800'
              >
